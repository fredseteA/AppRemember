  ...
  return (
    ...
    >
      ...
      <div className="relative z-10" style={{
        ...
        {/* Header */}
        <div style={{
          textAlign: 'center', marginBottom: 'clamp(32px, 5vw, 52px)',
          ...
          <h1 data-testid="page-title" style={{
            ...
            fontWeight: 700, color: '#1a2744', lineHeight: 1.1, marginBottom: 16,
          }}>
            Escolha seu Plano
          </h1>
          <p style={{
        ...
        {/* ── Campo de código do apoiador ─────────────────────────── */}
        <div style={{
          maxWidth: 440, margin: '0 auto clamp(36px, 6vw, 56px)',
          animation: 'revealSP 0.75s cubic-bezier(.22,1,.36,1) 0.08s both',
        }}>
          {!codeValid ? (
            <>
              <p style={{
                ...
                color: '#2a3d5e', marginBottom: 10, textAlign: 'center',
              }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  ...
                  <p style={{
                    fontFamily: '"Georgia", serif',
                    fontSize: '0.72rem', color: '#3a5070', marginTop: 2,
                  }}>
                    ...
                    <div style={{ marginBottom: 6 }}>
                      {hasDiscount && (
                        <div style={{
                          ...
                          fontWeight: 400, color: 'rgba(58,80,112,0.45)',
                      ...
                      <div style={{
                        ...
                        fontWeight: 700,
                        color: hasDiscount ? '#15803d' : '#1a2744',
                        lineHeight: 1,
                      }}>
                    ...
                    {plan.features.map((feature, i) => (
                      <div key={i} className="sp-feature">
                        <div style={{
                          ...
                          background: plan.highlighted ? 'rgba(90,168,224,0.15)' : 'rgba(26,39,68,0.07)',
                          border: plan.highlighted ? '1px solid rgba(90,168,224,0.3)' : '1px solid rgba(26,39,68,0.1)',
